...
bool I3CosmicRayFilter_13::KeepEvent(I3Frame& frame)
{
  ...
  if(triggers){
    ...
    if(I3TriggerHierarchyUtils::Count(*triggers, 
				      TriggerKey(TriggerKey::ICE_TOP,TriggerKey::SIMPLE_MULTIPLICITY,IceTopSMT_)) > 0){
    ...
    int InIceSMT8_ {1006};
    int InIceSMT3_ {1011};
    std::vector<TriggerKey> InIceSMTKeys{
        TriggerKey(TriggerKey::IN_ICE,TriggerKey::SIMPLE_MULTIPLICITY,InIceSMT8_),
        TriggerKey(TriggerKey::IN_ICE,TriggerKey::SIMPLE_MULTIPLICITY,InIceSMT3_)};
